...
public class SelectionComponent extends JComponent implements MouseListener, MouseMotionListener,
    ...
    public void paintComponent(Graphics g) {
        ...
        //Paint processing progress (if we recognize its type)
    ...
    private void paintMoveGuides(Graphics g, List<Point> controlPoints) {
        ...
        if (getModel() instanceof PointToPointSelectionModel
                || getModel() instanceof SplineSelectionModel
                || getModel() instanceof ScissorsSelectionModel) {

...
public class SelectorApp implements PropertyChangeListener {
    ...
    private JPanel makeControlPanel() {
        ...
        // Adding the main combo box for selection modes
        JComboBox<String> selecModules = new JComboBox<>(new String[]{"Point-to-point",
                "Spline",
                "Circle",
                "Intelligent scissors: Grey",
                "Intelligent scissors: Color"});

        // Add ActionListener to the main combo box
        selecModules.addActionListener(e -> {
            ...
            }else if (selecModules.getSelectedIndex() == 4) {
            setSelectionModel(new ScissorsSelectionModel("SuperFancyRainbowColorfulWeight", true));
        }
        ...
        selectText.setPreferredSize(new Dimension(50, 20));
